        ...
        <Card className="w-full max-w-3xl shadow-lg">
          ...
          <CardContent className="p-6">
            <div className="prose prose-lg max-w-none mx-auto text-gray-800">
              ...
              <p>Conformément au Règlement Général sur la Protection des Données (RGPD), vous disposez d'un droit d'accès, de rectification, de suppression, de limitation du traitement, d'opposition et de portabilité de vos données personnelles. Pour exercer ces droits, veuillez nous contacter à equipe@àfonte.fr.</p>
            </div>
          </CardContent>
        </Card>
      </main>
