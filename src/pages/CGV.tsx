        ...
        <Card className="w-full max-w-3xl shadow-lg">
          ...
          <CardContent className="p-6">
            <div className="prose prose-lg max-w-none mx-auto text-gray-800">
              ...
              <p>Les présentes conditions générales de vente régissent les ventes de programmes de musculation personnalisés sous forme d’abonnements mensuels sur le site afonte.fr.</p>
