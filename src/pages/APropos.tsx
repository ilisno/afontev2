        ...
        <Card className="w-full max-w-3xl shadow-lg">
          ...
          <CardContent className="p-6">
            <div className="prose prose-lg max-w-none mx-auto text-gray-800">
              <p>Bienvenue chez SmoothieBananeFraise, votre partenaire dédié à la transformation physique et à l'optimisation de vos performances en musculation.</p>
              ...
              <p>Rejoignez la communauté SmoothieBananeFraise et commencez dès aujourd'hui votre parcours vers une meilleure version de vous-même !</p>
            </div>
          </CardContent>
        </Card>
      </main>
